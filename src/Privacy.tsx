export default function Privacy() {
  return (
    <div class="p-10">
      <article class="space-y-6 text-left m-auto max-w-2xl text-black dark:text-white">
        ...
        <ul class="list-disc pl-6">
          <li>
            ...
            security, which is handled by our privacy-friendly service providers
          </li>
          <li>
            Usage data might include the pathname, which means us or our service
            providers could potentially see the names of your URL aliases
          </li>
        </ul>
        <br />
        <h1 class="text-2xl font-bold">Full Version</h1>

        <p class="text-base font-semibold">Scope</p>
        <p class="text-base">
          This privacy policy applies to the Linksquash website
          (linksquash.com).
        </p>

        <h2 class="text-xl font-bold">Data We Collect and How It’s Used</h2>
        ...
        <ul class="list-disc pl-6 space-y-2">
          <li>
            ...
            your visit or usage, URL, and other similar technical data.
          </li>
          <li>
        ...
        <h2 id="third-party-service-providers" class="text-xl font-bold">
        ...
        <h2 class="text-xl font-bold">User Rights Under GDPR</h2>
        <p class="text-base">
        ...
        <ul class="list-disc pl-6 space-y-2">
          ...
          <li>
            ...
            data we collect. Besides personal information collected by Service
            Providers, you can easily export your URL aliases as a .csv file by
            pressing "Export".
          </li>
          <li>
        ...
        <p class="text-base">
          ...
          the right to complain and the right to export data when applicable.
          For more details, please consult their privacy policies linked below:
        </p>
        <ul class="list-disc pl-6 space-y-2">
          <li>
        ...
        <h2 class="text-xl font-bold">Changes and Support</h2>
        <p class="text-base">
          We may update this privacy policy from time to time. Any changes will
          be published here with an updated revision date. If you have any
          questions, please contact us at:{" "}
          <a href="mailto:george@thingbomb.com" class="text-blue-500">
            george@thingbomb.com
          </a>
          .
        </p>

        <p class="text-base font-semibold">Last updated</p>
        <p class="text-base">April 14, 2025</p>
      </article>
    </div>
  );
}
